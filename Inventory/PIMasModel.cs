...
namespace Optimum.ERP.Models.Inventory
{
    ...
    public class PIDetModel
    {
        ...
        public int PINo { get; set; } //Add on
    ...
    public class PIMasFiltterModel
    {
        public int? PICode { get; set; }
        public int? AccCode { get; set; }
        public int? SalePurcType { get; set; }
